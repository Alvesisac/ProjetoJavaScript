...
Será usado o comando fetch() para localizar e 
carregar os filmes e exibir em uma página html*/

function carregarFilmes() {
    //LOCALIZE O ARQUIVO
    fetch("js/apiFilmes.json")

        //RECEBA OS DADOS LOCALIZADOS       //GUARDE OS DADOS NA VARIÁVEL DADOS
